...
namespace MovieOrganizer
{
    ...
    /* TODO: - Make the window bigger so it doesn't look like an 8 year old made it
             ...
             */
    public partial class MovieAdderForm : MovieOrganizerForm
    {
        ...
        protected virtual void FinalAdder_Click(object sender, EventArgs e)
        {
            ...
            if (RatingSelecter.SelectedIndex >= 0)
            {
            ...
            {
                MessageBox.Show("You must select a rating/certification for this movie.");
            }
        }
