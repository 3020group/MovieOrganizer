...
namespace MovieOrganizer
{
    ...
    public partial class MovieDeleter : MovieOrganizerForm
    {
        Movie result;
        ...
        {
            bool success = false;
            DialogResult makeSure = MessageBox.Show("The movie \"" + result.Title + "\" will be deleted. Are you sure you want to delete this movie?", "Confirm Action", MessageBoxButtons.YesNo);
        ...
        private void removeNode()
        {
            ...
            {
                if (curr.ChildNodes[0].InnerText.Trim().Equals(result.Title.Trim()))
                {
                   // MessageBox.Show("got");
        ...
        private void MovieTarget_KeyDown(object sender, KeyEventArgs e)
        {
